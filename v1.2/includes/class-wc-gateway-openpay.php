...
class WC_Gateway_Openpay extends WC_Payment_Gateway {
	...
	$apiSandboxEndpoint = 'https://sandbox-api.openpay.mx/v1';
        ...
        $this->openpay_checkout_image = $this->get_option('openpay_checkout_image', '');
    ...
    public function init_form_fields() {
        $this->form_fields = apply_filters('wc_openpay_settings', array(
            ...
            'title' => array(
                ...
                'default' => __('Tarjeta de crédito o débito (Openpay)', 'openpay-woosubscriptions')
            ),
            'description' => array(
            ...
            'openpay_checkout_image' => array(
                'title' => __('Openpay Checkout Image', 'openpay-woosubscriptions'),
                'description' => __('Optionally enter the URL to a 128x128px image of your brand or product. e.g. <code>https://yoursite.com/wp-content/uploads/2013/09/yourimage.jpg</code>', 'openpay-woosubscriptions'),
                'type' => 'text',
                'default' => ''
            ),    
        ));
    ...
    public function payment_fields() {
        ...
        <fieldset>
            ...
            <div class="openpay_new_card" <?php if ($checked === 0) : ?>style="display:none;"<?php endif; ?>
                 ...
                 data-image="<?php echo $this->openpay_checkout_image; ?>"
                 >
